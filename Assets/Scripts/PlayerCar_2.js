...
var centerOfGravity_X : float = 0;
var centerOfGravity_Y : float = -1;
var centerOfGravity_Z : float = 0.25;

function Start () {
	// I usually alter the center of mass to make the car more stable. I'ts less likely to flip this way.
	rigidbody.centerOfMass += Vector3(centerOfGravity_Y, centerOfGravity_X, centerOfGravity_Z);
}
